...
class SidebarNavigationTests(unittest.TestCase):
    ...
    def test_navigation_config_label_constants_stay_stable(self):
        ...
        self.assertEqual(STOCK_SECURITY_SEARCH_LABEL, get_page_by_label("个股", "🔎 个股/指数查询").label)
        self.assertEqual(STOCK_COMPANY_SCREENER_LABEL, get_page_by_label("个股", "🏢 公司筛选").label)
        self.assertEqual(STOCK_TECH_PICKER_LABEL, get_page_by_label("个股", "🎯 技术选股").label)
